...
const (
	...
	BudgetService_GetBudgetById_FullMethodName = "/BudgetService/GetBudgetById"
...
type BudgetServiceClient interface {
	...
	GetBudgetById(ctx context.Context, in *GetBudgetByIdReq, opts ...grpc.CallOption) (*GetBudgetByIdResp, error)
	GetBudgets(ctx context.Context, in *GetBudgetsReq, opts ...grpc.CallOption) (*GetBudgetsResp, error)
}
...
func (c *budgetServiceClient) CreateBudget(ctx context.Context, in *CreateBudgetReq, opts ...grpc.CallOption) (*CreateBudgetResp, error) {
...
func (c *budgetServiceClient) UpdateBudget(ctx context.Context, in *UpdateBudgetReq, opts ...grpc.CallOption) (*UpdateBudgetResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *budgetServiceClient) DeleteBudget(ctx context.Context, in *DeleteBudgetReq, opts ...grpc.CallOption) (*DeleteBudgetResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *budgetServiceClient) GetBudgetById(ctx context.Context, in *GetBudgetByIdReq, opts ...grpc.CallOption) (*GetBudgetByIdResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBudgetByIdResp)
...
func (c *budgetServiceClient) GetBudgets(ctx context.Context, in *GetBudgetsReq, opts ...grpc.CallOption) (*GetBudgetsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BudgetServiceServer interface {
	...
	GetBudgetById(context.Context, *GetBudgetByIdReq) (*GetBudgetByIdResp, error)
	GetBudgets(context.Context, *GetBudgetsReq) (*GetBudgetsResp, error)
...
func (UnimplementedBudgetServiceServer) CreateBudget(context.Context, *CreateBudgetReq) (*CreateBudgetResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBudget not implemented")
}
func (UnimplementedBudgetServiceServer) UpdateBudget(context.Context, *UpdateBudgetReq) (*UpdateBudgetResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateBudget not implemented")
}
func (UnimplementedBudgetServiceServer) DeleteBudget(context.Context, *DeleteBudgetReq) (*DeleteBudgetResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteBudget not implemented")
}
func (UnimplementedBudgetServiceServer) GetBudgetById(context.Context, *GetBudgetByIdReq) (*GetBudgetByIdResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBudgetById not implemented")
}
func (UnimplementedBudgetServiceServer) GetBudgets(context.Context, *GetBudgetsReq) (*GetBudgetsResp, error) {
...
func _BudgetService_GetBudgetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BudgetServiceServer).GetBudgetById(ctx, req.(*GetBudgetByIdReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BudgetService_GetBudgets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BudgetServiceServer).GetBudgets(ctx, req.(*GetBudgetsReq))
	}
	return interceptor(ctx, in, info, handler)
}
